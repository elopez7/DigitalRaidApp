...
namespace DigitalRaid.Data.Migrations
{
    public partial class Data_Models : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DRUserProject", x => new { x.MembersId, x.ProjectsId });
                    table.ForeignKey(
                        name: "FK_DRUserProject_AspNetUsers_MembersId",
                        column: x => x.MembersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DRUserProject_Projects_ProjectsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DRUserProject_ProjectsId",
                table: "DRUserProject",
                column: "ProjectsId");
